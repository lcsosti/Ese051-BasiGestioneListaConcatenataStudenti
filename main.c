...
void aggiungiElementoDiTesta(elemento**);
...
void aggiungiElementoDiTesta(elemento** testa){
   elemento* temp=NULL;
   
   temp=(elemento*)malloc(sizeof(elemento));
   if(temp==NULL){
       fprintf(stderr,"Errore durante lì aggiunta dell' elemento");
       exit(1);
   }
